...
"""
FastAPI application for the Emergency Dispatch Optimizer Environment.

This module creates an HTTP server that exposes the EmergencyDispatchOptimizerEnvironment
...
app = create_app(
    EmergencyDispatchOptimizerEnvironment,
    EmergencyDispatchOptimizerAction,
    EmergencyDispatchOptimizerObservation,
    env_name="Emergency_Dispatch_Optimizer",
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m Emergency_Dispatch_Optimizer.server.app
    ...
    multiple workers:
        uvicorn Emergency_Dispatch_Optimizer.server.app:app --workers 4
    """
    import uvicorn
